...
if (array_key_exists("loanproduct",$_GET)) {
  ...
  if($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    try {
      ...
      $query = $readDB->prepare('SELECT sloan_product_id,	name_of_loan_product,	loan_type,
        install_payment,loan_rate_type,interest_rate,loan_processing_fees,
            ...
            from loan_product_settings WHERE
      ...
      // create db query
            ...
            $query = $readDB->prepare('SELECT sloan_product_id,	name_of_loan_product,	loan_type,install_payment,loan_rate_type,
              interest_rate,loan_processing_fees,	minmum_amount,	maxmum_amount,number_of_guarantors,
                charge_penalties,	can_client_be_self_guarantor,deduct_installment_beofore_disbursment,
