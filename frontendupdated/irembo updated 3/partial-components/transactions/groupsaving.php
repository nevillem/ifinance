...
<div class="modal fade" id="addgroupsavingsmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" style="width:80%;" role="document">
    <div class="modal-content">
      <div class="modal-header text-center text-dark bg-white">
        <h4 class="modal-title h5 w-100 font-weight-bold">Capture New Group Savings</h4>
        <button type="button" class="btn btn-sm btn-warning" data-dismiss="modal">X</button>
      </div>
      <div class="modal-body mx-0">
        <form class="container" id="groupSavingsform" autocomplete="off" autocapitalize="on" action="#" method="post">
        <fieldset id="biodata">
            <div class="row">
              <div class="col-md-6 form-account-add-single-member" id="member-field">
                <div class="form-group mb-4 input-container">
                  <label for="selectMember" class="form-label">Group Name*</label>
              ...
              <div class="col-md-6 form-account-add-single-member" id="member-accounts-field">
                <div class="form-group mb-4 input-container">
                  <label for="selectMember" class="form-label">Account to Credit*</label>
                  <select name="group_account" id="group_account" class="group_account border-1 form-control-md input-text" required>
