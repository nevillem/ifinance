...
<div class="modal fade" id="clientToClient_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" style="width:80%;" role="document">
    <div class="modal-content">
      <div class="modal-header text-center text-white bg-warning">
        <h4 class="modal-title h5 w-100 font-weight-bold">Transfer - Client to Client</h4>
        <button type="button" class="btn btn-sm btn-warning" data-dismiss="modal">X</button>
      </div>
      <div class="modal-body mx-0">
        <form class="container" id="transferToClientForm" action="#" method="post">
        <fieldset id="biodata">
            ...
            <div class="form-group mb-4">
              <select name="member_account_from" id="member_account_from" class="member_account w-100 border-1 form-control-md input-text" required>
            ...
            <div class="col-md-6 form-account-add-single-member" id="dateofpayment-field">
              ...
              <div class="col-md-6 form-account-add-single-member" id="member-field">
                <div class="form-group mb-4 input-container">
                  <label class="form-label">Receiving Client</label>
              ...
              <div class="col-md-6 form-account-add-single-member" id="member-accounts-field">
                <div class="form-group mb-4 input-container">
                  <label class="form-label">Receiving Client Account</label>
