            ...
            <div class="col-lg-12">
              <div class="card mb-5 mb-lg-0">
                <div class="card-header">
                    <h2 class="h6 mb-0 text-uppercase text-center">Fixed Savings/Withdraws (<span id="numoffixed">0</span>) </h2>
                  <!-- <a href="#" data-toggle="modal" data-target="#addfixedsavingsmodal" data-backdrop="static" data-keyboard="false" class="btn btn-outline-dark float-right">Fixed Savings</a> -->
                </div>
