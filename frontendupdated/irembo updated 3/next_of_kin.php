...
<body id="content">
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-5 mb-lg-0">
                                <div class="card-header">
                                    <h2 class="h6 mb-0 text-uppercase text-center">Next Of Kin (<span id="numofmembers">0</span>) </h2>
                                ...
                                <div class="card-body mt-3 mb-3">
                                    <table class="table table-striped table-hover table-bordered" id="dataTables-kin">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>#</th>
    ...
    <script src="middlewares/user/kin.js?v=1"></script>
    <?php require_once('partial-components/nextOfKin/kin.php'); ?>
