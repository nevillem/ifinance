...
<?php require 'components/head.php'; ?>
   <body id="content">
            ...
            <div class="col-lg-12">
              <div class="card mb-5 mb-lg-0">
                ...
                <div class="card-body mt-3 mb-3">
                    ...
                    <form class="row needs-validation"id="managerbillpaymentform"  method="post">
    ...
    <!-- JavaScript files-->
    <?php require_once 'partial-components/paybills/paybills-manager.php'; ?>

    <?php require_once 'components/user/javascript.php'; ?>
    <script src="middlewares/user/header.js"></script>
    <script src="middlewares/user/paybills-manager.js"></script>
