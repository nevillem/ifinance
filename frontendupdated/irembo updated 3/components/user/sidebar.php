...
<li class="sidebar-list-item">
  <a href="#" data-toggle="collapse" data-target="#expensepages" aria-expanded="false" aria-controls="pages" class="sidebar-link text-muted  <?php if($pagename === 'Income'): ?>
    ...
    <div id="expensepages" class="collapse">
      <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
        <li class="sidebar-list-item" id="links"><a href="vendors" class="sidebar-link text-muted pl-lg-5">Vendors </a></li>
        <li class="sidebar-list-item" id="links"><a href="paybills" class="sidebar-link text-muted pl-lg-5">Pay Bills </a></li>
        <li class="sidebar-list-item" id="links"><a href="income" class="sidebar-link text-muted pl-lg-5">Income </a></li>
        <!--<li class="sidebar-list-item" id="links"><a href="budgeting" class="sidebar-link text-muted pl-lg-5">Budgeting</a></li>-->
  ...
  <!--income and expenditure end-->
      ...
      <li class="sidebar-list-item">
      <a href="#" data-toggle="collapse" data-target="#pages" aria-expanded="false" aria-controls="pages" class="sidebar-link text-muted  <?php if($pagename === 'Inquiry'): ?>
         <?php echo 'active'; ?>
         <?php endif; ?>">
        <i class="o-settings-window-1 mr-3 text-gray"></i>
      <span>Customer Inquiry</span></a>
      <!-- <div id="pages" class="collapse"> -->
        <ul class="sidebar-menu list-unstyled border-left border-primary border-thick collapse" id="pages" >
          ...
          <!-- <li class="sidebar-list-item"><a href="complusory" class="sidebar-link text-muted pl-lg-5">Compulsory</a></li> -->
          <li class="sidebar-list-item"><a href="accountbalance-all" class="sidebar-link text-muted pl-lg-5">Client Account balance</a></li>
        </ul>
      <!-- </div> -->
    </li>
  </ul>
