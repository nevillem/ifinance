      ...
      success: function(response) {
        ...
        //   console.log(response)
          ...
          for (var i = 0; i < nums; i++){
            // console.log(response)
              no++
              let status = response.data.transactions[i].status=='successful'?'<td class="badge badge-success"> Success </td>':'<td class="badge badge-danger"> Failed </td>'
              var transaction = '';
              transaction += '<tr>';
              transaction += '<td></td>';
              ...
              transaction += '<td class="badge badge-dark">'+response.data.transactions[i].method+ '</td>';                    
