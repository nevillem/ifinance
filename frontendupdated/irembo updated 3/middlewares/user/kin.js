            ...
            success: function (response) {
                ...
                for (var i = 0; i < nums; i++) {
                    ...
                    kin += '<td class="fw-60 text-center"><a href="#">' +
                        '<a href="#" data-toggle="modal" class=\'nextofkin\' data-target=\'#editnextofkin\' id=' + response.data.nKin[i].id +
    ...
    $(document).delegate('.nextofkin', 'click', function (event) {
        ...
        async function geteditmember() {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#doj_update').val(response.data.nKin[0].doj);
        ...
        $('#editmemberform').submit(function (event) {
            ...
            if ($('#editmemberform').valid()) {
                ...
                console.log("Edit data________", form_data)
                editMembers();
