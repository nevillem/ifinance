...
$(document).ready(function () {
    ...
    //get member accounts for checking balance
        ...
        if ($('#checkbalanceform').valid()) {
            ...
            async function checkbalance() {
                $.ajax({
                    ...
                    success: function(response) {
                        $(".balances__").removeClass('d-none');
                        $(".printBtn").removeClass('d-none');
                        
                        var num =response.data.rows_returned;
                        if(num !=0){
                        ...
                        $("#account_name").html(response.data.accountbalance[0].firstname +' '+ response.data.accountbalance[0].lastname );
                        // $("#account_name").html(response.data.accountbalance[0].account);
                        $("#account_number").html(response.data.accountbalance[0].accountnumber);
                        $("#availablebalance").html('UGX ' +response.data.accountbalance[0].accountbalance +'/=');
                        $("#actualbalance").html('UGX ' +response.data.accountbalance[0].actualbalance +'/=');
                        return;
                    }
                    },
