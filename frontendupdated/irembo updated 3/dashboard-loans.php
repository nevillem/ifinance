      ...
      <div class="h5 mb-0 font-weight-bold text-gray-800">UGX. <span id="totalloans">0</span></div>                                         
      </div>                                         
      ...
      <div class="col-10">                                
      <p class="mb-0 tex-dark"><span id="percantageloans">0</span></p>                              
      </div>                                                      
      </div>                          
      </div>
      </div>                         
      ...
      Pending Loans</div>                                             
      <div class="h5 mb-0 font-weight-bold text-gray-800">UGX. <span id="pendingloans">0</span></div>                                         
      </div>                                         
      ...
      <div class="col-10">                                
      <p class="mb-0 tex-dark"><span id="percantagepending">0</span></p>                              
      </div>                                                      
      </div>                          
      </div>
      ...
      Active Loans</div>                                             
      <div class="h5 mb-0 font-weight-bold text-gray-800"><span id="activeLoans">0</span></div>                                         
      </div>                                         
      ...
      <p class="mb-0 tex-dark">
        <span id="totalaccounts" class="font-weight-bold text-dark-800">0</span></p>                              
      </div>                                                      
      </div>                          
      </div>                             
      </div>                         
      ...
      <i class="fas fa-solid fa-user-check fa- text-white"></i>                                                
          ...
          <!-- <div class="col-xl-3 col-md-6 mb-4 block_login">
                ...
                <section>
                    ...
                    <div class="col-lg-7 mb-4 mb-lg-0">
                      <div class="card">
                        <div class="card-header">
                          <h2 class="h6 text-uppercase mb-0">Active Vs Pending Loans</h2>
                        </div>
                        <div class="card-body">
                          <p class="text-gray">Monthly trend between Active and Pending Loans</p>
                  ...
                  <div class="dot mr-3 bg-green"></div>                    
                  <div class="text">                       
                  <h6 class="mb-0 "> <span id="overdueLoans">0</span>
                    </h6>
                  <span class="text-dark text-uppercase">Over Due Loans</span>                    
                  </div>                   
                  </div>                   
                  ...
                  <div class="row mb-1">
                    <div class="col-lg-6">
                      <div class="card mb-5 mb-lg-0">
                        <div class="card-header">
                          <h2 class="h6 mb-0 text-uppercase">Loans Due Today</h2>
                        </div>
                        <div class="card-body" id="daily_loans_dom">
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="card mb-5 mb-lg-0">
                        <div class="card-header">
                          <h2 class="h6 mb-0 text-uppercase">Over Due Loans</h2>
                        </div>
                        <div class="card-body" id="daily_loans_dom">
                        </div>
                      </div>
          ...
          <script src="middlewares/user/dashboard-loans.js"> </script>
