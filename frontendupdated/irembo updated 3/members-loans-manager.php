            ...
            <div class="col-lg-12">
              <div class="card mb-5 mb-lg-0">
                <div class="card-header">
                    <h2 class="h6 mb-0 text-uppercase text-center">Loan Applications (<span id="numofloansapps">0</span>) </h2>
                ...
                <table class="table table-striped table-hover table-bordered display nowrap" id="dataTables-loans">
                    <thead>
                      <tr>
                        <th></th>
                        <th>#</th>
