...
<?php require 'components/head.php'; ?>
   <body id="content">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card mb-5 mb-lg-0">
                ...
                <table class="table table-striped table-hover table-bordered display nowrap" id="dataTables-groupsavings">
                    <thead>
                    <tr>
                    <th>#</th>
                          <th> </th>
    ...
    <script src="middlewares/user/groupsaving-manager.js"></script>
