...
<?php require 'components/head.php'; ?>
  <body class="no-display-for-devices">
          ...
          <div class="col-lg-5 px-lg-4">
            ...
            <div class="card mt-4 mb-5">
              ...
              <div class="card-body mt-0">
                ...
                <p class="text-center mt-3 text-capitalize"><a href="#">Click Here</a> to recover password</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- JavaScript files-->
    <?php require 'components/user/javascript.php'; ?>
    <script src="middlewares/user/login-users.js"></script>
    <script>
