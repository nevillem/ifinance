      ...
      <i class="fas fa-coins fa-2x text-white-300"></i>                                         
      </div>  
      </div>                                 
      </div>  
      ...
      <i class="fas fa-user text-white-300"></i>
                ...
                <section>
                  <div class="row mb-4">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                      <div class="card">
                        <div class="card-header">
                          <h2 class="h6 text-uppercase mb-0">Income Vs Expenses</h2>
                        </div>
                        <div class="card-body">
                          <p class="text-gray">Monthly trend between Income and Expenditure</p>
                          <div class="chart-holder">
                            <canvas id="income-expense" style="max-height: 14rem !important;" class="w-100"></canvas>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0 row mt-4">
                      <div class="col-md-6">
                      <div class="card mb-2">
                        <div class="card-body">
                          <div class="row align-items-center flex-row">
                            <div class="col-lg-12">
                              <h6 class="mb-2 d-flex align-items-center text-dark text-bold"><span id="totalloanamount">0</span><span class="dot bg-green d-inline-block ml-3"></span></h6>
                              <span class="text-muted text-uppercase small">Total Loans</span>
                              <hr><small class="text-muted" id="totalloans">0</small>
                            </div>
                            <div class="col-lg-0">
                            </div>
                          </div>
                      ...
                      <div class="card mb-2">
                        <div class="card-body">
                          <div class="row align-items-center flex-row">
                            <div class="col-lg-12">
                              <h6 class="mb-2 d-flex align-items-center text-dark text-bold"><span id="pendingloans">0</span><span class="dot bg-green d-inline-block ml-3"></span></h6>
                              <span class="text-muted text-uppercase small">Pending Loans</span>
                              <hr><small class="text-muted" id="pendingloansamount">0</small>
                            </div>
                            <div class="col-lg-0">
                            </div>
                          </div>
                      ...
                      <div class="card mb-2">
                        <div class="card-body">
                          <div class="row align-items-center flex-row">
                            <div class="col-lg-12">
                              <h6 class="mb-2 d-flex align-items-center text-dark text-bold"><span id="activeloans">0</span><span class="dot bg-green d-inline-block ml-3"></span></h6>
                              <span class="text-muted text-uppercase small">Active Loans</span>
                              <hr><small class="text-muted" id="activeloansamount">0</small>
                            </div>
                            <div class="col-lg-0">
                            </div>
                          </div>
                      ...
                      <div class="card mb-2">
                        <div class="card-body">
                          <div class="row align-items-center flex-row">
                            <div class="col-lg-12">
                              <h6 class="mb-2 d-flex align-items-center text-dark text-bold"><span id="overdueloans">0</span><span class="dot bg-green d-inline-block ml-3"></span></h6>
                              <span class="text-muted text-uppercase small">Over Due Loans</span>
                              <hr><small class="text-muted" id="overdueloansamount">0</small>
                            </div>
                            <div class="col-lg-0">
                            </div>
                          </div>
          ...
          <script src="middlewares/user/dashboard-manager.js"> </script>
