...
<div class="modal fade" id="addnextofkinmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="addmemberimagesmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal fade" id="editnKinmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
          aria-hidden="true">
          <div class="modal-dialog modal-lg" style="width:80%;" role="document">
            <div class="modal-content">
              <div class="modal-header text-center text-white bg-warning">
                <h4 class="modal-title h5 w-100 font-weight-bold">Edit Next of Kin</h4>
              ...
              <div class="modal-body mx-0">
                ...
                <fieldset id="biodata_update">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group mb-4 input-container">
                        <label for="" class="form-label">Address</label>
                      <input type="text"  name="address" id="address_update" rows="4" class="form-control border-0 shadow form-control-md input-text" required></textarea>
                      </div>
                      </div>
                      ...
                      <div class="form-group mb-4 input-container">
                        <label for="" class="form-label">Relationship</label>
                      <input type="text"  name="relationship" id="relationship_update" rows="4" class="form-control border-0 shadow form-control-md input-text" required></textarea>
                      </div>
                      <div class="form-group mb-4 input-container">
                        <label for="" class="form-label">Inheritance</label>
                      <input type="text"  name="inheritance" id="inheritance_update" rows="4" class="form-control border-0 shadow form-control-md input-text" required></textarea>
                      </div>
                      </div>
