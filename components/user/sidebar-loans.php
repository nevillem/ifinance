<div id="sidebar" class="sidebar py-3">
  ...
  <li class="sidebar-list-item">
  <a href="#" data-toggle="collapse" data-target="#reportpage" aria-expanded="false"
      aria-controls="reportpage" class="loansreportmenu sidebar-link text-muted
     <?php if($pagename === 'LoanReport'): ?>
       <?php echo 'active'; ?>
       <?php endif; ?>">
  ...
  <!-- <div id="pages" class="collapse"> -->
    <ul class="sidebar-menu list-unstyled collapse border-left border-primary border-thick" id="reportpage" >
      <li class="sidebar-list-item"><a href="#" class="sidebar-link text-muted pl-lg-5 application">Disbursed Loans</a></li>
  </ul>
  <!-- </div> -->
</li>
  </ul>
