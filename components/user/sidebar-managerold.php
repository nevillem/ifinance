<div id="sidebar" class="sidebar py-3">
  ...
  <ul class="sidebar-menu list-unstyled">
        ...
        <li class="sidebar-list-item"><a href="members-manager" class="sidebar-link text-muted 
        <?php if($pagename === 'Accounts'): ?>
         <?php echo 'active'; ?>
         <?php endif; ?>">
        <i class="o-user-1 mr-3 text-gray "></i><span>Accounts</span></a></li>
      ...
      <div id="pages" class="collapse">
        <ul class="sidebar-menu list-unstyled border-left border-primary border-thick">
          <li class="sidebar-list-item"><a href="fixed-manager" class="sidebar-link text-muted pl-lg-5">Fixed</a></li>
          <!-- <li class="sidebar-list-item"><a href="complusory" class="sidebar-link text-muted pl-lg-5">Compulsory</a></li> -->
          <li class="sidebar-list-item"><a href="shares-manager" class="sidebar-link text-muted pl-lg-5">Shares</a></li>
        </ul>
      </div>
    </li>
    <li class="sidebar-list-item">
