    ...
    <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
      <li class="nav-item">
        <div class="d-none d-lg-block">
          <div class="position-relative mb-0">
            <p  class="p-2 mt-3 mr-5">Branch: <span id="branch"></span> </p>
          </div>
      </div>
      </li>
      <li class="nav-item dropdown mr-3"><a id="notifications" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle text-gray-400 px-1"><i class="fa fa-bell"></i><span class="notification-icon"></span></a>
              <div aria-labelledby="notifications" class="dropdown-menu"><a href="#" class="dropdown-item">
                ...
                <a href="#" class="dropdown-item text-center"><small class="font-weight-bold headings-font-family text-uppercase">Notifications(0)</small>
              </a>
              </div>
            </li>
      <li class="nav-item dropdown ml-auto">
        ...
        <div aria-labelledby="userInfo" class="dropdown-menu">
          ...
          <strong class="d-block text-uppercase headings-font-family" id="name"></strong>
          <small id="email"></small> <br>
          <small id="role"></small><br>
          <small id="contact"></small></a>
          <div class="dropdown-divider"></div><a href="profile" class="dropdown-item">Profile</a>
