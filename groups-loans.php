...
<?php require 'components/head.php'; ?>
   <body id="content">
            ...
            <div class="col-lg-12">
              <div class="card mb-5 mb-lg-0">
                <div class="card-header">
                    <h2 class="h6 mb-0 text-uppercase text-center">Group Loan Applications</h2>
                </div>
                <div class="card-body mt-3 mb-3">
                  <form class="row" id="loanAplicationForm" method="post">
                      <div class="form-group col-md-5">
                      <label id="" class="form-label">Select a Group</label>
                      <select name="groupid" id="groupid" data-live-search="true" data-width="100%" class="border-1 form-control-md input-text" required>
                      <option disabled selected hidden>Select or Search Group Account</option>
                      </select> 
    ...
    <script src="middlewares/user/group-loans.js"></script>
