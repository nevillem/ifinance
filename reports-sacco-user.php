              ...
              <div class="card mb-5 mb-lg-0">
                ...
                <ul class="nav nav-pills mb-3 row" id="pills-tab" role="tablist">
                        <li class="nav-item col-4" role="presentation">
                          <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">My Members</a>
                        </li>
                        <li class="nav-item col-4" role="presentation">
                        ...
                        <form action="" class="row" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control-md" id="exampleFormControlSelect1">
                              ...
                              <option>Share Statement</option>
                              <option>Accounts Statement</option>
                              <option>Group Accounts Statement</option>
                              <option>Individual Accounts Statement</option>
                            </select>
                            </div>
