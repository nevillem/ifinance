...
<?php require 'components/head.php'; ?>
   <body id="content">
            ...
            <div class="col-lg-12">
              <div class="card mb-5 mb-lg-0">
                <div class="card-header">
                  ...
                  <a href="#" data-toggle="modal" data-target="#addsavingsmodal" data-backdrop="static" data-keyboard="false" class="btn btn-outline-dark float-right">New savings</a>
                </div>
    ...
    <script src="middlewares/user/saving.js"></script>
    <?php require_once('partial-components/transactions/saving.php'); ?>
